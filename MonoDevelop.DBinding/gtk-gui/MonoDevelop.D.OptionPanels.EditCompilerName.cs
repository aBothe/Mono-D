...
namespace MonoDevelop.D.OptionPanels
{
	public partial class EditCompilerName
	{
		...
		protected virtual void Build ()
		{
			...
			this.Title = global::Mono.Unix.Catalog.GetString ("Edit compiler preset name");
			...
			this.label1.LabelProp = global::Mono.Unix.Catalog.GetString ("Enter the new compiler preset name");
			...
			this.vbox3.Add (this.txtPresetName);
			global::Gtk.Box.BoxChild w3 = ((global::Gtk.Box.BoxChild)(this.vbox3 [this.txtPresetName]));
			w3.Position = 1;
			w3.Expand = false;
			w3.Fill = false;
			w1.Add (this.vbox3);
			...
			w4.Expand = false;
			w4.Fill = false;
			// Internal child MonoDevelop.D.OptionPanels.EditCompilerName.ActionArea
