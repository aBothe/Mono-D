...
namespace MonoDevelop.D
{
	public partial class ProjectDependenciesWidget
	{
		...
		protected virtual void Build ()
		{
			...
			this.label16.LabelProp = MonoDevelop.Core.GettextCatalog.GetString ("Checking a project in this list will add an include (that points to the respective project's base directory) to this project automatically.");
